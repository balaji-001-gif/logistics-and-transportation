...
def install_demo_data():
    ...
    # 2. Warehouses
    warehouses = [
        {"warehouse_name": "Mumbai Hub", "city": "Mumbai", "state": "Maharashtra", "pincode": "400001", "warehouse_type": "Hub"},
        {"warehouse_name": "Delhi Gateway", "city": "New Delhi", "state": "Delhi", "pincode": "110001", "warehouse_type": "Hub"},
        {"warehouse_name": "Bengaluru Cross-Dock", "city": "Bengaluru", "state": "Karnataka", "pincode": "560001", "warehouse_type": "Cross-Dock"},
        {"warehouse_name": "Chennai Port Facility", "city": "Chennai", "state": "Tamil Nadu", "pincode": "600001", "warehouse_type": "Bonded"},
        {"warehouse_name": "Pune Spoke", "city": "Pune", "state": "Maharashtra", "pincode": "411001", "warehouse_type": "Spoke"},
        {"warehouse_name": "Hyderabad Spoke", "city": "Hyderabad", "state": "Telangana", "pincode": "500001", "warehouse_type": "Spoke"},
    ]
    for w in warehouses:
    ...
    drivers = [
        {"naming_series": "DRV-.YYYY.-.####", "full_name": "Ramesh Kumar Singh",
         ...
         "dl_expiry_date": add_months(today(), 24), "dl_class": "HGV",
        ...
        {"naming_series": "DRV-.YYYY.-.####", "full_name": "Suresh Prasad Yadav",
         ...
         "dl_expiry_date": add_months(today(), 18), "dl_class": "HGV",
        ...
        {"naming_series": "DRV-.YYYY.-.####", "full_name": "Muthu Selvam",
         ...
         "dl_expiry_date": add_months(today(), 12), "dl_class": "HGV",
        ...
        {"naming_series": "DRV-.YYYY.-.####", "full_name": "Devendra Patel",
         ...
         "dl_expiry_date": add_months(today(), 8), "dl_class": "HGV",
    ...
    routes = [
        ...
        {"route_name": "Mumbai - Pune", "origin_city": "Mumbai", "destination_city": "Pune",
         ...
         "distance_km": 148, "estimated_transit_days": 1, "route_type": "Expressway",
